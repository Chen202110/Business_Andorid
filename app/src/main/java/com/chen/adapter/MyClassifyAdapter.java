...
public class MyClassifyAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<ClassifyInfo> classifyInfoList;
    private int selectedPosition = -1;
    public MyClassifyAdapter(Context context,List<ClassifyInfo> classifyInfos){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.classify_item,parent,false);
